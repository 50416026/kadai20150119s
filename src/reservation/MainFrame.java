...
public class MainFrame extends Frame implements ActionListener,WindowListener,KeyListener
 {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ( e.getSource() == buttonVacancy){ // 空き状況確認ボタン
			...
			result = reservationControl.makeExplanation(this);
		}
		else if (e.getSource() == buttonConfirm){
			result = reservationControl.makeConfirm(choiceFacility.getSelectedItem(), tfYear.getText(), tfMonth.getText(), tfDay.getText());
		}
		else if (e.getSource() == buttonCancel){
			result = reservationControl.makeCancel(this);
		}
